...
describe('McpDiscoveryService', () => {
  ...
  beforeEach(async () => {
    ...
    mockProtocolAdapters = {
      sse: mockAdapter as unknown as SseAdapter,
      http: mockAdapter as unknown as HttpAdapter, // Use the same mock instance for simplicity if appropriate
      stdio: mockAdapter,
      ws: mockAdapter as unknown as WebSocketAdapter
    };
